...
export default defineComponent({
  ...
  components: {
    ...
    VideoMetadata: defineAsyncComponent(() => import('src/components/video/VideoMeta.vue')),
    VideoTitle: defineAsyncComponent(() => import('src/components/video/VideoTitle.vue')),
  },
